...
return [
    ...
    'When you register a domain, the WHOIS of your domain name publishes your personal contact information (such as Name, Company Name, Address, Telephone Number, Email Address) as Contact Details for that domain name. The information becomes available to anyone who performs a WHOIS lookup query of your domain name.' => 'Когда вы регистрируете домен, WHOIS вашего доменна публикует личную контактную инфо7мацию (например, имя, название компании, адрес, номер телефона, адрес электронной почты) в качестве контактной информации для этого домена. Информация становится доступной любому, кто выполняет поиск вашего домена в WHOIS.',
