...
return [
    ...
    'Unfreezing domain...' => '',
    'Url forwarding' => '',
    'WHOIS protect has been disabled' => '',
    'WHOIS protect has been enabled' => '',
    ...
    'Approve outgoing transfer' => 'Подтвердить исходящий трансфер',
    'Cancel preincoming transfer' => 'Отменить входящий трансфер',
    'Cancel incoming transfer' => 'Отменить входящий рансфер',
    'Reject outgoing transfer' => 'Отменить исходящий трансфер',
    ...
    'Domain is premium' => 'Домен относится к премиум',
    ...
    'Domain name is not registered yet, or domain name is premium, or the domain zone is not supported.' => 'Этот домен еще не зарегистрирован, или имя домена относится к премиум названиям, или доменная зона не поддерживается.',
    ...
    'Domain transfer was approved' => 'Трансфер домена подтвержден',
    ...
    'Failed approve domain transfer' => 'Не удалось подтвердить трансфер домена',
    ...
    'Lock has been disabled' => 'Защита от трансфера отключена',
    'Lock has been enabled' => 'Защита от трансфера включена',
    ...
    'Send FOA' => 'Отправить FOA',
    'Send FOA to registant\'s email' => 'Отправить FOA на email регистранта',
    'Send FOA to client\'s email' => 'Отправить FOA на email клиента',
    'Send FOA to WHOIS email' => 'Отправить FOA на email, что указан во WHOIS',
    'Send FOA to specific email' => 'Отправить FOA на указанный email',
    'Set IPs' => 'Сменить IP',
    ...
    'WHOIS protect has been changed' => 'WHOIS protect успешно изменен',
    ...
    'WHOIS protection' => 'Защита WHOIS',
    'WHOIS protect is enabled' => 'Защита WHOIS включена',
    'WHOIS protect is disabled' => 'Защита WHOIS выключена',
    'Secure domain service is enabled' => 'Домен защищен от изменений',
    ...
    'Zone' => 'Зоны',
    'Zone has been created' => 'Зона была создана',
    'Zone has been updated' => 'Зона была обновлена',
    'Zone has been disabled' => 'Зона была отключена',
    'Zone has been enabled' => 'Зона была включена',
    'Zone has been deleted' => 'Зона была удалена',
    'Has contacts' => 'Есть контакты',
    ...
    'When you register a domain, the WHOIS of your domain name publishes your personal contact information (such as Name, Company Name, Address, Telephone Number, Email Address) as Contact Details for that domain name. The information becomes available to anyone who performs a WHOIS lookup query of your domain name.' => 'Когда вы регистрируете домен, WHOIS вашего доменна публикует личную контактную информацию (например, имя, название компании, адрес, номер телефона, адрес электронной почты) в качестве контактной информации для этого домена. Информация становится доступной любому, кто выполняет поиск вашего домена в WHOIS.',
    'Your personal information is, therefore, is at risk from being collected by data miners, who can then target you via email, telephone calls, postal messages, etc.' => 'Таким образом, ваша личная информация подвергается риску быть собранной третьими лицами, которые затем могут присылать вам  спам по электронной почте, надоедать телефонным звонкам, почтовым сообщениям и т. п.',
    'Using the Privacy Protection service, you may prevent such abuse. When you enable WHOIS privacy for your domain name, we replace your Contact Details in the WHOIS information with our company contact details, thus, masking your personal contact data.' => 'Используя услугу защиты WHOIS, вы можете предотвратить злоупотребление вашими контактными данными. Когда вы включаете защиту WHOIS для своего доменна, мы заменяем ваши контактные данные в информации WHOIS на контактные данные нашей компании, таким образом, маскируя ваши личные контактные данные.',
