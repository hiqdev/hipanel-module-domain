...
return [
    ...
    'More information on domain transfer process can be found on {ican} site and especially in {pilicy_on_transfer_of_registrations}.' => 'Более подробную информацию о процессе трансфера доменов вы можете получить на сайте {ican} и особенно в соответствующем документе: {pilicy_on_transfer_of_registrations}.',
