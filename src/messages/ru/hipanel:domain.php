...
return [
    ...
    'Using the Privacy Protection service, you may prevent such abuse. When you enable WHOIS privacy for your domain name, we replace your Contact Details in the WHOIS information with our company contact details, thus, masking your personal contact data.' => 'Используя службу защиты WHOIS, вы можете предотвратить такое злоупотребление вашими контактными данными. Когда вы включаете защиту WHOIS для своего доменна, мы заменим ваши контактные данные в информации WHOIS на контактные данные нашей компании, таким образом, маскируя ваши личные контактные данные.',
];
