...
$this->title = count(explode(',', $domains)) > 1 ? Yii::t('hipanel:domain', 'Domains transfer failed') : Yii::t('hipanel:domain', 'Domain transfer was failed');
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-widget">
                ...
                <div class="box-body">
                    <p><?= Yii::t('hipanel:domain', 'The money for the failed transaction will be returned to your account.') ?></p>
