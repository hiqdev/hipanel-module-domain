            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#single"
                                          data-toggle="tab"><?= Yii::t('hipanel/domain', 'Single domain transfer') ?></a></li>
...
<?php else : ?>
    ...
    <div class="box">
        ...
        <div class="box-body">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'label' => Yii::t('hipanel', 'Additional message'),
        ...
        <div class="box-footer">
            <?= Html::submitButton('<i class="fa fa-shopping-cart"></i> ' . Yii::t('hipanel', 'Add to cart'), ['class' => 'btn btn-success']) ?>
